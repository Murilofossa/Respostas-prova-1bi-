...
let idade=[];
  ...
  pedidos.unshift(registrarPedido("Ana", "Hambúrguer", 1, 10));
  pedidos.unshift(registrarPedido("Bruno", "Lasanha", 2, 17));
  pedidos.unshift(registrarPedido("Carlos", "Feijoada", 3, 65));
